...
function writeAgentFiles(profileDir: string, port: number) {
  // Shell script — same logic as xhs-cdp-start.sh in MCP branch
...
# If Chrome is already listening on the debug port, nothing to do
...
# Open Chrome with debug port (exactly as xhs-mcp-cdp SKILL.md)
